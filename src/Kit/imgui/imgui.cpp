...
#include "Kit/imgui/imgui_internal.h"
...
ImGuiStyle::ImGuiStyle()
{
    ...
    WindowFillAlphaDefault  = 1.0f;            // Default alpha of window background, if not specified in ImGui::Begin()
...
#include "Kit/stb/stb_textedit.h"

...
bool kit::UISystem::__imgui_mousePressed[3] = {false, false, false};
float kit::UISystem::__imgui_mouseWheel = 0.0;
GLuint kit::UISystem::__imgui_fontTexture = 0;
int kit::UISystem::__imgui_shaderHandle = 0;
int kit::UISystem::__imgui_vertHandle = 0;
int kit::UISystem::__imgui_fragHandle = 0;
int kit::UISystem::__imgui_attribLocationTex = 0;
int kit::UISystem::__imgui_attribLocationProjMtx = 0;
int kit::UISystem::__imgui_attribLocationPosition = 0;
int kit::UISystem::__imgui_attribLocationUV = 0;
int kit::UISystem::__imgui_attribLocationColor = 0;
unsigned int kit::UISystem::__imgui_vboHandle = 0;
unsigned int kit::UISystem::__imgui_vaoHandle = 0;
unsigned int kit::UISystem::__imgui_elementsHandle = 0;
...
void kit::UISystem::allocateShared()
{
  ...
  io.RenderDrawListsFn = kit::UISystem::__imgui_renderDrawLists;
  io.SetClipboardTextFn = kit::UISystem::__imgui_setClipboardText;
  io.GetClipboardTextFn = kit::UISystem::__imgui_getClipboardText;
}
...
void kit::UISystem::__imgui_renderDrawLists(ImDrawData* draw_data)
{
  ...
  KIT_GL(glUseProgram(kit::UISystem::__imgui_shaderHandle));
  KIT_GL(glUniform1i(kit::UISystem::__imgui_attribLocationTex, 0));
  KIT_GL(glUniformMatrix4fv(kit::UISystem::__imgui_attribLocationProjMtx, 1, GL_FALSE, &ortho_projection[0][0]));
  KIT_GL(glBindVertexArray(kit::UISystem::__imgui_vaoHandle));
  ...
  for (int n = 0; n < draw_data->CmdListsCount; n++)
  {
    ...
    KIT_GL(glBindBuffer(GL_ARRAY_BUFFER, __imgui_vboHandle));
    ...
    KIT_GL(glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, __imgui_elementsHandle));
...
const char* kit::UISystem::__imgui_getClipboardText()
{
  kit::Window::Ptr win = kit::UISystem::m_window.lock();
  if (win)
  {
...
void kit::UISystem::__imgui_setClipboardText(const char * text)
{
  kit::Window::Ptr win = kit::UISystem::m_window.lock();
  if (win)
  {
...
bool kit::UISystem::createFontsTexture()
{
  ...
  KIT_GL(glGenTextures(1, &kit::UISystem::__imgui_fontTexture));
  KIT_GL(glBindTexture(GL_TEXTURE_2D, kit::UISystem::__imgui_fontTexture));
  ...
  io.Fonts->TexID = (void *)(intptr_t)kit::UISystem::__imgui_fontTexture;
...
bool kit::UISystem::createDeviceObjects()
{
  ...
  kit::UISystem::__imgui_shaderHandle = glCreateProgram();
  kit::UISystem::__imgui_vertHandle = glCreateShader(GL_VERTEX_SHADER);
  kit::UISystem::__imgui_fragHandle = glCreateShader(GL_FRAGMENT_SHADER);
  KIT_GL(void());

  KIT_GL(glShaderSource(kit::UISystem::__imgui_vertHandle, 1, &vertex_shader, 0));
  KIT_GL(glShaderSource(kit::UISystem::__imgui_fragHandle, 1, &fragment_shader, 0));
  KIT_GL(glCompileShader(kit::UISystem::__imgui_vertHandle));
  KIT_GL(glCompileShader(kit::UISystem::__imgui_fragHandle));
  KIT_GL(glAttachShader(kit::UISystem::__imgui_shaderHandle, kit::UISystem::__imgui_vertHandle));
  KIT_GL(glAttachShader(kit::UISystem::__imgui_shaderHandle, kit::UISystem::__imgui_fragHandle));
  KIT_GL(glLinkProgram(kit::UISystem::__imgui_shaderHandle));

  kit::UISystem::__imgui_attribLocationTex = glGetUniformLocation(kit::UISystem::__imgui_shaderHandle, "Texture");
  kit::UISystem::__imgui_attribLocationProjMtx = glGetUniformLocation(kit::UISystem::__imgui_shaderHandle, "ProjMtx");
  kit::UISystem::__imgui_attribLocationPosition = glGetAttribLocation(kit::UISystem::__imgui_shaderHandle, "Position");
  kit::UISystem::__imgui_attribLocationUV = glGetAttribLocation(kit::UISystem::__imgui_shaderHandle, "UV");
  kit::UISystem::__imgui_attribLocationColor = glGetAttribLocation(kit::UISystem::__imgui_shaderHandle, "Color");

  KIT_GL(void());

  KIT_GL(glGenBuffers(1, &kit::UISystem::__imgui_vboHandle));
  KIT_GL(glGenBuffers(1, &kit::UISystem::__imgui_elementsHandle));

  KIT_GL(glGenVertexArrays(1, &kit::UISystem::__imgui_vaoHandle));
  KIT_GL(glBindVertexArray(kit::UISystem::__imgui_vaoHandle));
  KIT_GL(glBindBuffer(GL_ARRAY_BUFFER, kit::UISystem::__imgui_vboHandle));
  KIT_GL(glEnableVertexAttribArray(kit::UISystem::__imgui_attribLocationPosition));
  KIT_GL(glEnableVertexAttribArray(kit::UISystem::__imgui_attribLocationUV));
  KIT_GL(glEnableVertexAttribArray(kit::UISystem::__imgui_attribLocationColor));

#define OFFSETOF(TYPE, ELEMENT) ((size_t)&(((TYPE *)0)->ELEMENT))
  KIT_GL(glVertexAttribPointer(kit::UISystem::__imgui_attribLocationPosition, 2, GL_FLOAT, GL_FALSE, sizeof(ImDrawVert), (GLvoid*)OFFSETOF(ImDrawVert, pos)));
  KIT_GL(glVertexAttribPointer(kit::UISystem::__imgui_attribLocationUV, 2, GL_FLOAT, GL_FALSE, sizeof(ImDrawVert), (GLvoid*)OFFSETOF(ImDrawVert, uv)));
  KIT_GL(glVertexAttribPointer(kit::UISystem::__imgui_attribLocationColor, 4, GL_UNSIGNED_BYTE, GL_TRUE, sizeof(ImDrawVert), (GLvoid*)OFFSETOF(ImDrawVert, col)));
#undef OFFSETOF
...
void kit::UISystem::invalidateDeviceObjects()
{
  ...
  if (kit::UISystem::__imgui_vaoHandle) KIT_GL(glDeleteVertexArrays(1, &kit::UISystem::__imgui_vaoHandle));
  if (kit::UISystem::__imgui_vboHandle) KIT_GL(glDeleteBuffers(1, &kit::UISystem::__imgui_vboHandle));
  if (kit::UISystem::__imgui_elementsHandle) KIT_GL(glDeleteBuffers(1, &kit::UISystem::__imgui_elementsHandle));
  kit::UISystem::__imgui_vaoHandle = kit::UISystem::__imgui_vboHandle = kit::UISystem::__imgui_elementsHandle = 0;

  if (kit::UISystem::__imgui_vertHandle != 0)
  {
    KIT_GL(glDetachShader(kit::UISystem::__imgui_shaderHandle, kit::UISystem::__imgui_vertHandle));
    KIT_GL(glDeleteShader(kit::UISystem::__imgui_vertHandle));
  }
  kit::UISystem::__imgui_vertHandle = 0;

  if (kit::UISystem::__imgui_fragHandle != 0)
  {
    KIT_GL(glDetachShader(kit::UISystem::__imgui_shaderHandle, kit::UISystem::__imgui_fragHandle));
    KIT_GL(glDeleteShader(kit::UISystem::__imgui_fragHandle));
  }
  kit::UISystem::__imgui_fragHandle = 0;

  if (kit::UISystem::__imgui_shaderHandle != 0)
  {
    KIT_GL(glDeleteProgram(kit::UISystem::__imgui_shaderHandle));
  }
  kit::UISystem::__imgui_shaderHandle = 0;

  if (kit::UISystem::__imgui_fontTexture)
  {
    KIT_GL(glDeleteTextures(1, &kit::UISystem::__imgui_fontTexture));
    ImGui::GetIO().Fonts->TexID = 0;
    kit::UISystem::__imgui_fontTexture = 0;
  }
}
...
void kit::UISystem::handleEvent(kit::WindowEvent const & evt)
{
  ...
  if (evt.type == kit::WindowEvent::MouseButtonPressed)
  {
    ...
    {
      kit::UISystem::__imgui_mousePressed[evt.mouse.button] = true;
    }
  }

  if (evt.type == kit::WindowEvent::MouseScrolled)
  {
    kit::UISystem::__imgui_mouseWheel += (float)evt.mouse.scrollOffset.y;
  }
...
void kit::UISystem::prepareFrame(double const & ms)
{
  ...
  for (int i = 0; i < 3; i++)
  {
    io.MouseDown[i] = kit::UISystem::__imgui_mousePressed[i] || glfwGetMouseButton(win->getGLFWHandle(), i) != 0;    // If a mouse press event came, always pass it as "mouse held this frame", so we don't miss click-release events that are shorter than 1 frame.
    kit::UISystem::__imgui_mousePressed[i] = false;
  }

  io.MouseWheel = kit::UISystem::__imgui_mouseWheel;
  kit::UISystem::__imgui_mouseWheel = 0.0f;
